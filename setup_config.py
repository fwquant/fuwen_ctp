...
if system == 'Windows':
    include_dirs = [
        'fw_ctp/api/include/ctp',
        'fw_ctp/api/include',
        'fw_ctp/api/vnctp',
        pybind11.get_include(),
    ]
    library_dirs = ['fw_ctp/api/libs']
    ...
    api_dir = os.path.join(current_dir, 'fw_ctp', 'api')
    
    include_dirs = [
        'fw_ctp/api/include/mac/ctp',
        'fw_ctp/api/include/ctp',
        'fw_ctp/api/include',
        'fw_ctp/api/vnctp',
        pybind11.get_include(),
    ]
    library_dirs = ['.', 'fw_ctp/api']
    ...
    extra_link_args = ['-Wl,-rpath,./fw_ctp/api']
...
if system == 'Darwin':  # macOS
    ...
    ext_modules.append(Extension(
        'fw_ctp.api.vnctpmd',
        sources=['fw_ctp/api/vnctp/vnctpmd/vnctpmd.cpp'],
    ...
    ext_modules.append(Extension(
        'fw_ctp.api.vnctptd',
        sources=['fw_ctp/api/vnctp/vnctptd/vnctptd.cpp'],
        include_dirs=include_dirs,
        library_dirs=library_dirs,
        extra_compile_args=extra_compile_args,
        extra_link_args=extra_link_args,
...
setup(
    ...
    zip_safe=False,
    packages=['fw_ctp', 'fw_ctp.api', 'fw_ctp.gateway'],
    package_dir={
        'fw_ctp': 'fw_ctp',
        'fw_ctp.api': 'fw_ctp/api',
        'fw_ctp.gateway': 'fw_ctp/gateway',
    },
    package_data={
        'fw_ctp.api': ['*.dll', '*.pyd', '*.so'],
    },
    python_requires='>=3.7',
    install_requires=[
        'vnpy>=3.0.0',
